...
/**
 * Find discord (anomaly) points in a time series based on the matrix profile.
 * This function identifies the top discord points in the time series, which represent
 * the most unusual or anomalous subsequences.
 *
 * @param matrixProfile: Matrix profile containing similarity scores for each subsequence
 * @param exclusionLen: Exclusion length to prevent overlapping discords
 * @return: Vector containing indices of the top discords
 */
