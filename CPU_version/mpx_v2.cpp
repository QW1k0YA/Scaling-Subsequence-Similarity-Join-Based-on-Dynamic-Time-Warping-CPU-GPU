...
using namespace  std;
/**
 * Computes the matrix profile using Pearson correlation coefficient for motif discovery.
 * This function calculates the matrix profile and profile index for a time series using
 * Pearson correlation as the similarity measure, which is used for Euclidean distance-based
 * motif discovery.
 *
 ...
 * @return: RETURN_MPX struct containing matrix profile, profile indices, motifs and discords
 */
