 ...
 * using a band constraint (r) to limit the warping path.
 *
 ...
 * @param threshold_2: Threshold for early abandoning during computation
 * @param cb: Cumulative boundary values for early abandoning
 * @param cb_prune: Counter for pruning events
 * @param low_index: Lower index bound (currently unused)
 * @param high_index: Upper index bound (currently unused)
