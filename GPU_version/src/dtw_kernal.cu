...
/**
 * CUDA kernel for performing Keogh lower bound and DTW computation on parallelogram regions.
 * This kernel applies the Keogh lower bound followed by full DTW computation for
 * subsequence pairs that passed previous pruning stages, using shared memory for efficiency.
 *
 * @param my_subs: Array of normalized subsequences
 * @param my_L: Array of lower envelopes for subsequences
 * @param my_U: Array of upper envelopes for subsequences
 * @param subseqLen: Length of each subsequence
 * @param bsf: Best-so-far distance array
 * @param subcount: Total number of subsequences
 * @param w: Warping window size
 * @param indices: Array of indices to process
 * @param diag_of_indices: Array of diagonal positions for each index
 */
...
/**
 * CUDA kernel for performing Keogh lower bound and DTW computation without using shared memory.
 * This version is optimized for cases where shared memory usage would exceed limits,
 * processing longer subsequences by using global memory instead of shared memory.
 *
 * @param my_subs: Array of normalized subsequences
 * @param my_L: Array of lower envelopes for subsequences
 * @param my_U: Array of upper envelopes for subsequences
 ...
 * @param indices: Array of indices to process
 * @param diag_of_indices: Array of diagonal positions for each index
 * @param num_of_dtw: Number of DTW computations to perform
 */
...
/**
 * CUDA kernel for performing Keogh lower bound and DTW computation without shared memory and with normalization.
 * This kernel handles the most computationally intensive cases where subsequences are long and normalization
 * is applied, using global memory and optimized for normalized DTW computation.
 *
 * @param my_subs: Array of normalized subsequences
 ...
 * @param indices: Array of indices to process
 * @param diag_of_indices: Array of diagonal positions for each index
 * @param bl_size: Block size for computation
 */
